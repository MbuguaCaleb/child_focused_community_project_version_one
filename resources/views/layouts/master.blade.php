	...
	<div class="page-wrapper">
				...
				<div class="sidemenu-container navbar-collapse collapse fixed-menu">
					<div id="remove-scroll">
						<ul class="sidemenu page-header-fixed p-t-20" data-keep-expanded="false" data-auto-scroll="true"
							...
							<li class="nav-item">
								<a href="index.html#" class="nav-link nav-toggle"> <i class="material-icons">desktop_mac</i>
							...
							<li class="nav-item">
								<a href="index.html#" class="nav-link nav-toggle"> <i class="material-icons">grain</i>
							...
							<li class="nav-item">
								<a href="index.html#" class="nav-link nav-toggle"> <i class="material-icons">album</i>
							...
							<div class="card-box ">
								...
								<div class="card-body ">
									<div class="row">
											...
											<li>
												<div class="row">
													<div class="col-md-8 col-sm-8">
														...
														<div class="details">
															<div class="title">
																<a href="index.html#">Rajesh Mishra</a>
											...
											<li>
												<div class="row">
													<div class="col-md-8 col-sm-8">
														...
														<div class="details">
															<div class="title">
																<a href="index.html#">Sarah Smith</a>
											...
											<li>
												<div class="row">
													<div class="col-md-8 col-sm-8">
														...
														<div class="details">
															<div class="title">
																<a href="index.html#">John Simensh</a>
											...
											<li>
												<div class="row">
													<div class="col-md-8 col-sm-8">
														...
														<div class="details">
															<div class="title">
																<a href="index.html#">Priya Sarma</a>
											...
											<li>
												<div class="row">
													<div class="col-md-8 col-sm-8">
														...
														<div class="details">
															<div class="title">
																<a href="index.html#">Serlin Ponting</a>
											...
											<li>
												<div class="row">
													<div class="col-md-8 col-sm-8">
														...
														<div class="details">
															<div class="title">
																<a href="index.html#">Priyank Jain</a>
										...
										<div class="full-width text-center p-t-10">
											<a href="index.html#" class="btn purple btn-outline btn-circle margin-0">View All</a>
										</div>
									</div>
								</div>
							</div>
			...
			<div class="chat-sidebar-container" data-close-on-body-click="false">
				<div class="chat-sidebar">
					<ul class="nav nav-tabs">
						<li class="nav-item">
							<a href="index.html#quick_sidebar_tab_1" class="nav-link active tab-icon" data-toggle="tab">Theme
							</a>
						</li>
						<li class="nav-item">
							<a href="index.html#quick_sidebar_tab_2" class="nav-link tab-icon" data-toggle="tab"> Chat
							</a>
						</li>
						<li class="nav-item">
							<a href="index.html#quick_sidebar_tab_3" class="nav-link tab-icon" data-toggle="tab"> Settings
							</a>
						</li>
					</ul>
									...
									<ul class="list-unstyled">
										<li class="complete">
											<div class="theme-color sidebar-theme">
												<a href="index.html#" data-theme="white"><span class="head"></span><span
														class="cont"></span></a>
												<a href="index.html#" data-theme="dark"><span class="head"></span><span
														class="cont"></span></a>
												<a href="index.html#" data-theme="blue"><span class="head"></span><span
														class="cont"></span></a>
												<a href="index.html#" data-theme="indigo"><span class="head"></span><span
														class="cont"></span></a>
												<a href="index.html#" data-theme="cyan"><span class="head"></span><span
														class="cont"></span></a>
												<a href="index.html#" data-theme="green"><span class="head"></span><span
														class="cont"></span></a>
												<a href="index.html#" data-theme="red"><span class="head"></span><span
														class="cont"></span></a>
											</div>
										</li>
									</ul>
									...
									<ul class="list-unstyled">
										<li class="theme-option">
											<div class="theme-color logo-theme">
												<a href="index.html#" data-theme="logo-white"><span class="head"></span><span
														class="cont"></span></a>
												<a href="index.html#" data-theme="logo-dark"><span class="head"></span><span
														class="cont"></span></a>
												<a href="index.html#" data-theme="logo-blue"><span class="head"></span><span
														class="cont"></span></a>
												<a href="index.html#" data-theme="logo-indigo"><span class="head"></span><span
														class="cont"></span></a>
												<a href="index.html#" data-theme="logo-cyan"><span class="head"></span><span
														class="cont"></span></a>
												<a href="index.html#" data-theme="logo-green"><span class="head"></span><span
														class="cont"></span></a>
												<a href="index.html#" data-theme="logo-red"><span class="head"></span><span
														class="cont"></span></a>
											</div>
										</li>
									</ul>
										...
										<li class="theme-option">
											<div class="theme-color header-theme">
												...
												<a href="index.html#" data-theme="header-green"><span class="head"></span><span
														class="cont"></span></a>
												<a href="index.html#" data-theme="header-red"><span class="head"></span><span
														class="cont"></span></a>
											</div>
										</li>
									</ul>
		...
		<div class="page-footer">
			<div class="page-footer-inner"> 2018 &copy; Spice Hotel Template By
				<a href="https://radixtouch.com/cdn-cgi/l/email-protection#493b2c2d3a3d283b3d212c242c092e24282025672a2624" target="_top" class="makerCss">RedStar Theme</a>
			</div>
